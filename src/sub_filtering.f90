...
!---------------------------------------------------
 ...
 !----Smooth indix 
        ...
        do j=1,ny
        do i=i1,i2
            p1=abs(f0(5,i+1,j,k)-f0(5,i  ,j,k))   ! f(5,:,:,:)=p()
            p2=abs(f0(5,i  ,j,k)-f0(5,i-1,j,k))
		    
			alpha=0.1d0*min (abs((p1-p2)/(p1+p2+eps0))**4 , 1.d0)
           do m=1,NVAR1
...
!--------------------------------------------------------------------------
 ...
 !----Smooth indix 
        ...
        do j=i1,i2
        do i=1,nx
            p1=abs(f0(5,i,j+1,k)-f0(5,i,  j,k))   ! f(5,:,:,:)=p()
            p2=abs(f0(5,i,j,  k)-f0(5,i,  j-1,k))
...
!--------------------------------------------------------------------------
 ...
 !----Smooth indix 
        ...
        do j=1,ny
        do i=1,nx
            p1=abs(f0(5,i,j,k+1)-f0(5,i,  j,k))   ! f(5,:,:,:)=p()
            p2=abs(f0(5,i,j,  k)-f0(5,i,  j,k-1))
		    alpha=0.1d0* min (abs((p1-p2)/(p1+p2+eps0))**4 , 1.d0)
           do m=1,NVAR1
!		     f(m,i,j,k)=(1.d0-alpha)*f0(m,i,j,k)+ &  
