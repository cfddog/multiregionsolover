...
方腔 Re100/1000 & Ghia (1982) & $u$-RMS 0.021 / 0.044；Re5000 运行中 \\
槽道（AC） & Poiseuille & $u_{\max}$ 误差 $<0.3\%$，RMS $<0.15\%$ \\
圆柱 Re40/200 & Dennis--Chang / Williamson & 运行/后处理中 \\
平板 $Re_L=10^6$ & Blasius & 调试中 \\
Beavers--Joseph & 复合 Darcy--Brinkman & 运行中 \\
